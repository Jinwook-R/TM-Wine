...
from api.LabelDetectionModel_ForServer.tmp import LOGGER, colorstr, emojis
...
def kmean_anchors(dataset='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    ...
    if isinstance(dataset, str):  # *.yaml file
        ...
        from api.LabelDetectionModel_ForServer.yolov5.utils.datasets import LoadImagesAndLabels
